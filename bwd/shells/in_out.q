...
#setenv CTM_CONC_1      "$OUTDIR2/$CONCfile"
 setenv A_CONC_1        "$OUTDIR/$ACONCfile -v"
 setenv CTM_CHK_1       "$OUTDIR2/$CHKfile"
 setenv CTM_ADJ_1       "$OUTDIR/$ADJfile -v"
 setenv CTM_FRC_1       "$OUTDIR3/$FRCfile"
 setenv CTM_GRD_1       "$OUTDIR/$GRDfile -v"
