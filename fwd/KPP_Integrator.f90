...
! Time                 : Tue Apr  3 17:22:17 2007
! Working directory    : /home/amir/KPP/kpp-2.2.1.December2006
...
MODULE KPP_Integrator
  ...
  USE KPP_Pars, ONLY: KPPNSP, KPPNRCT, LU_NONZERO
  USE KPP_Glob
  USE KPP_Util
  IMPLICIT NONE
  PUBLIC
...
!   rcntrl(3)=1.0d0
   ...
   CALL Rosenbrock(KPPNSP,VAR,TIN,TOUT,   &
         ATOL,RTOL,                &
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE KPP_Pars, ONLY: KPPNSP, KPPNRCT, LU_NONZERO
! USE KPP_Glob, ONLY: FIX, RCONST, TIME
 USE KPP_Function, ONLY: Fun
! USE KPP_Rates, ONLY: Update_SUN, Update_RCONST
!~~~> Input variables
